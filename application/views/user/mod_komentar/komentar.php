			...
			<tbody>
				...
				?>
					...
					<tr>
						...
						<a href="<?php echo base_url();?>user/balaskomentar/<?php echo $r['id_komentar'];?>">Balas komentar</a> | 
						<!--<a href="<?php echo base_url();?>user/hapuskomen/<?php echo $r['id_komentar'];?>">Hapus komentar</a> |--> 
						<?php if($r['publish'] == "N" ){?>
						<a href="<?php echo base_url();?>user/approve/<?php echo $r['id_komentar'];?>">Approve</a>
						<?php } else{ ?>
						<a href="<?php echo base_url();?>user/unapprove/<?php echo $r['id_komentar'];?>">Unapprove</a>
						<?php } ?>
						</td>
