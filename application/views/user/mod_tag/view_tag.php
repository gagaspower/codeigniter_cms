						...
						<div class="page-header">
							<h1>
								<center>Tag Cloud</center>
											...
											<a href="<?php echo base_url();?>user/tambahtag">
												...
												<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top" id="provinsi">
													...
													<tbody>
														...
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="<?php echo base_url();?>user/edittag/<?php echo $t['id_tag'];?>"><button class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button></a>

															<!--<a href="<?php echo base_url();?>user/hapustag/<?php echo $t['id_tag'];?>"><button class="btn btn-xs btn-danger">
