					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="<?php echo base_url();?>user/gantipaswod">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class=""><a href="<?php echo base_url();?>user/artikel" ><i class="menu-icon fa fa-newspaper-o"></i><span class="menu-text"> Artikel </span></a></li>
					<li class=""><a href="<?php echo base_url();?>user/tag" ><i class="menu-icon fa fa-tags "></i><span class="menu-text"> Tag Artikel</span></a></li>
					<li class=""><a href="<?php echo base_url();?>user/komentar" ><i class="menu-icon fa fa-comments  "></i><span class="menu-text"> Komentar 
					<?php 
					/*
						$hitung = $this->user_model->hitungkomen()->num_rows();
						if($hitung > 0){
						echo "($hitung) Baru";
						}else{ echo ""; }	
					*/
