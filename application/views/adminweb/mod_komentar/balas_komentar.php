						...
						<div class="page-header">
							<h1>
								...
								<form class="form-horizontal" role="form" action="<?php echo base_url();?>admin/adminbalaskomen" method="POST">
								...
								<div class="form-group">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="<?php echo base_url();?>admin/komentar"><button class="btn" type="button">
