						...
						<div class="page-header">
							<h1>
								...
								<form class="form-horizontal" role="form" action="<?php echo base_url();?>admin/simpankategori" method="POST">
								<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" style="display: none;">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="nama kategori"> Nama Kategori </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="nama_kategori" class="col-xs-10 col-sm-5" />
										</div>
									</div>
